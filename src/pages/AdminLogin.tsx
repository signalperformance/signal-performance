          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your admin email" required />
              </div>
              ...
              <Button type="submit" className="w-full" disabled={isLoading || isCreatingAdmin}>
              ...
              {error && error.includes('might not exist') && <Button type="button" variant="outline" className="w-full" disabled={isCreatingAdmin || isLoading} onClick={handleCreateAdminUser}>
                  {isCreatingAdmin ? <div className="flex items-center gap-2">
