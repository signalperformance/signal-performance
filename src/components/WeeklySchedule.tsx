...
import { Clock, Move, Dumbbell, Activity, Zap } from 'lucide-react';
...
const WeeklySchedule = () => {
  ...
  type Item = { time: string; labelKey: 'mobility' | 'strength' | 'cardio' | 'power' };
              ...
              <Card className="overflow-hidden border-border/70 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent className="pt-0">
                  <ul className="space-y-2" role="list">
                    {col.items.map((it, i) => (
                      <li key={i} className="flex items-center justify-between rounded-md border border-border/60 bg-card/50 px-3 py-2">
