...
const WhoItsFor = () => {
  ...
  return <section id="who-its-for" className="section-padding bg-background">
          ...
          <Card className="text-left shadow-xl bg-gradient-to-br from-emerald-50 via-white to-green-50 hover:shadow-2xl transition-all duration-500 hover:scale-105 h-full border-2 border-green-100 group animate-scale-in">
            <CardContent className="p-8 md:p-10">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-lg md:text-2xl lg:text-3xl font-bold font-lora text-signal-charcoal group-hover:text-green-700 transition-colors duration-300">{t('whoitsfor.for.title')}</h3>
              </div>
          ...
          <Card className="text-left shadow-xl bg-gradient-to-br from-red-50 via-white to-rose-50 hover:shadow-2xl transition-all duration-500 hover:scale-105 h-full border-2 border-red-100 group animate-scale-in">
            <CardContent className="p-8 md:p-10">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-lg md:text-2xl lg:text-3xl font-bold font-lora text-signal-charcoal group-hover:text-red-700 transition-colors duration-300">{t('whoitsfor.notfor.title')}</h3>
              </div>
              <ul className="space-y-6">
