      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="relative">
          ...
          <div className="md:hidden flex flex-col items-center">
            {/* Group for package and first 3 steps */}
            <div className="relative flex flex-col items-center w-full max-w-xs sm:max-w-sm">
              <Card className="bg-signal-charcoal text-white border-signal-gold/50 shadow-xl w-full max-w-[280px] sm:max-w-xs text-center z-10">
              ...
              {/* Vertical line connecting package to steps */}
            ...
            <div className="w-px h-6 bg-gray-300 my-4" />
          ...
          <div className="hidden md:block relative pt-12">
            ...
            <div className="absolute h-0.5 bg-gray-300 z-10 top-[61px] left-[12.5%] right-[12.5%]" />

            {/* Assessment package bracket and box */}
            {/* Horizontal line */}
            <div className="absolute h-[3px] bg-signal-charcoal z-20 top-[-24px] left-[12.5%] w-[37.5%]" />
            {/* Vertical line left */}
            <div className="absolute w-[3px] bg-signal-charcoal z-20 top-[-24px] h-[85px] left-[12.5%]" />
            {/* Vertical line right */}
            <div className="absolute w-[3px] bg-signal-charcoal z-20 top-[-24px] h-[85px] left-[50%]" />

            {/* The package box */}
            <div className="absolute z-30 top-[-24px] left-[31.25%] transform -translate-x-1/2 -translate-y-1/2">
