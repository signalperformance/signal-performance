  ...
  return <footer id="contact" className="bg-signal-black text-white py-6 scroll-mt-24 lg:scroll-mt-32">
      <div className="container mx-auto container-padding">
        <div className="text-center mb-4">
          <p className="text-slate-50 text-sm mb-2">{t('footer.followUs')}</p>
          <a 
            href="https://www.instagram.com/signalperformance/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-slate-50 hover:text-signal-gold transition-colors"
