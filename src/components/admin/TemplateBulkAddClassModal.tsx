...
interface TemplateBulkAddClassModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAddClasses: (classEntries: TemplateClassEntry[]) => void;
}

export function TemplateBulkAddClassModal({ isOpen, onClose, onAddClasses }: TemplateBulkAddClassModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Add Classes to Template</DialogTitle>
          <DialogDescription>
            Create the same class across multiple days of the week for this template.
          </DialogDescription>
        </DialogHeader>
